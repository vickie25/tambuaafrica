  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-background">
        <Navbar />
        <PageHero
          eyebrow="Full-trip support"
          title="Services"
          description="Tambua Africa plans more than game drives. We book tickets, coordinate ground and air transfers, and reserve lodges and camps to your specifications, so logistics stay in one place with a team that knows Kenya."
          imageSrc="/images/maasai-mara-authentic.webp"
          imageAlt="Kenya savannah"
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {cards.map((card) => {
              ...
              return (
                <article
                  key={card.path}
                  className="surface-card-interactive flex flex-col overflow-hidden"
                >
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    />
                    <div className="absolute left-4 top-4 flex h-12 w-12 items-center justify-center rounded-xl bg-background/90 text-accent shadow-sm backdrop-blur-sm">
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <div className="mt-5 flex flex-col gap-2 sm:flex-row">
                      ...
                      <Button asChild variant="outline" className="btn-pill bg-background hover:bg-muted">
